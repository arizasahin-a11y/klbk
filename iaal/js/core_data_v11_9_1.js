...
const DataManager = {
    ...
    _getStorageKey: function () {
        // 1. ÖNCELİK: URL! (Eğer kullanıcı aynı sekmede başka okula geçerse eski session'ı görmemesi için URL her zaman öncelikli olmalı)
        ...
        // 2. ÖNCELİK: Session Storage (Eğer kök dizindeysek)
