...
`;
    ...
    // =========================================================================
    // Ortak modül olarak js/session_attendance_report.js içine taşınmıştır.
    if (!window.openSessionAttendanceReport) {
        window.openSessionAttendanceReport = function(...args) {
            console.warn('js/session_attendance_report.js yükleniyor...');
        };
    }
